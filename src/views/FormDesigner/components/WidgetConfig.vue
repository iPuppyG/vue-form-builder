<template>
	<div v-if="show" class="config-container">
		<div class="widget-config-title">{{ $t("fm.description.configSetting") }}</div>
		<el-form class="widget-config-form" label-position="top">
			<!-- 基础信息 -->
			<div v-if="data.type !== 'grid'" class="config-group">
				<div class="group-title">{{ $t("fm.config.widget.basic") }}</div>
				<div class="group-list">
					<!-- 标题 -->
					<el-form-item v-if="data.type != 'grid'" class="required-field" :label="$t('fm.config.widget.name')">
						<el-input v-model="data.name" />
					</el-form-item>

					<!-- 字段名 -->
					<el-form-item v-if="data.type != 'grid'" class="required-field" :label="$t('fm.config.widget.model')">
					...
					<el-form-item :label="$t('fm.config.widget.description')">
						<el-input v-model="data.options.description" type="textarea" :rows="3" />
					</el-form-item>
			...
			<div v-if="data.type !== 'grid'" class="config-group">
				...
				<div class="group-list">
					...
					>
						<el-input-number v-model="data.options.maxlength" size="mini" :min="1" />
					</el-form-item>
					<el-form-item
					...
					>
						...
						>
							...
							<el-option value="idCardNumber" :label="$t('fm.config.widget.idCardNumber')" />
							<el-option value="phone" :label="$t('fm.config.widget.phone')" />
						</el-select>
					</el-form-item>
			...
			<div v-if="data.type !== 'grid'" class="config-group">
				...
				<el-form-item v-if="Object.keys(data.options).indexOf('size') >= 0" :label="$t('fm.config.widget.size')">
					...
					<el-slider v-model.number="data.options.size.width" style="width: 90px" type="number" />
	...
	<div v-else class="widget-config-empty">
		<i class="icon ri-settings-3-line" />
