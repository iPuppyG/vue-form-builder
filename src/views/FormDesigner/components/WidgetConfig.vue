<template>
  ...
  >
    ...
    >
        ...
        <div class="group-list">
          ...
          >
            ...
            >
              ...
              <el-option
                value="idCardNumber"
                :label="$t('fm.config.widget.idCardNumber')"
              />
              <el-option
                value="phone"
                :label="$t('fm.config.widget.phone')"
              />
            </el-select>
          </el-form-item>
      ...
      <div
        v-if="data.type === 'grid'"
        class="config-group layout-config-group"
      >
        <el-form-item :label="$t('fm.config.widget.gutter')">
          <el-input-number
